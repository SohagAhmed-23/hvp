...
class mod_hvp_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->setType('h5pmaxscore', PARAM_INT);
         ...
         $mform->addElement('header', 'attemptlimitationhdr', get_string('attemptlimitation', 'hvp'));
        $mform->addElement('advcheckbox', 'attemptlimitation', get_string('attemptlimitation', 'hvp'), get_string('attemptlimitation_desc', 'hvp'));
        $mform->setType('attemptlimitation', PARAM_BOOL);
        $mform->setDefault('attemptlimitation', 0);
